object LearningScala1 {
  ...
  val p:Double=(pi*2)                             //> p  : Double = 6.2831853
  println(p)                                      //> 6.2831853
  val p1:String=p.toString                        //> p1  : String = 6.2831853
  print(p1)                                       //> 6.2831853
  val pattern2="""[+-]?\\d+\\.?(\\d+)?""".r       //> pattern2  : scala.util.matching.Regex = [+-]?\\d+\\.?(\\d+)?
  //val pattern2="""\d(.\d{3})?.*""".r
  //val pattern1 = """.(\d{1}\.)?..*""".r
  val pattern2(p3)= p1                            //> scala.MatchError: 6.2831853 (of class java.lang.String)
                                                  //| 	at LearningScala1$.$anonfun$main$1(LearningScala1.scala:72)
                                                  ...
                                                  //| 	at LearningScala1$.main(LearningScala1.scala:1)
                                                  //| 	at LearningScala1.main(LearningScala1.scala)
  println(p3)
