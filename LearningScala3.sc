object LearningScala3 {
  ...
  // Then, do the same thing using a function literal instead of a separate, named function.
    ...
    val str="my name si nishant"                  //> str  : String = my name si nishant
    ...
    println(result2)
    }                                             //> conv: (str: String)Unit
    conv("my name is nishant kumar")              //> MY NAME IS NISHANT KUMAR
    
  def transformString(x1: String, f1: String => String) : String = {
  	f1(x1)
  }                                               //> transformString: (x1: String, f1: String => String)String
   val result3 = transformString(str,str1=>str.toUpperCase())
                                                  //> result3  : String = MY NAME SI NISHANT
   println (result3)                              //> MY NAME SI NISHANT
